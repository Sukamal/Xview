...
public class ATMstateDashBoardFragment extends Fragment {
    ...
    public ATMstateDashBoardFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.fragment_atmstate_dashboard, container, false);
    ...
    private void setPagerAdapter() {
        ...
        fragmentList.add(new ATMstateDashBoardGraphFragment());
