...
public class TransactionDashBoardDetailsFragment extends Fragment implements View.OnClickListener{
    ...
    @Bind(R.id.ll_trans_details_container)
    LinearLayout llDetailsContainer;



    public TransactionDashBoardDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.fragment_transaction_dashboard_details, container, false);
    ...
    private void setValuesToUiComponent(){
        ...
        if(transactionHeadingList != null){
            ...
            for(TransactionHeading transactionHeading : transactionHeadingList){
                ...
                llDetailsContainer.addView(headerView);
            }
        }
    ...
    private void doTestBuildTransactionDetails(){
        ...
        transactionRowValue = new TransactionRowValue("POS Debit","7");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("Pinless Credit","25");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("ATM Withdrawal","6");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("ATM Balance Inquiry","1");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("Check Cashing","26");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("DCC ATM","0");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("DCC Signature","2");
        transactionHeading.transactionRowValueList.add(transactionRowValue);
        ...
        transactionHeading= new TransactionHeading();
        transactionHeading.heading = "Processor";
        transactionHeading.transactionRowValueList = new ArrayList<>();

        transactionRowValue = new TransactionRowValue("Processor","Count", "%");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("CDS","39");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("Tele Check","27");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("International","0");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("AJB","0");
        transactionHeading.transactionRowValueList.add(transactionRowValue);
        ...
        transactionHeading= new TransactionHeading();
        transactionHeading.heading = "Check Cashing Response";
        transactionHeading.transactionRowValueList = new ArrayList<>();

        transactionRowValue = new TransactionRowValue("Transaction Type","Count","%");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("ECA Approved","26");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("Non ECA Approved","0");
        transactionHeading.transactionRowValueList.add(transactionRowValue);

        transactionRowValue = new TransactionRowValue("Check Cashing Declined","0");
        transactionHeading.transactionRowValueList.add(transactionRowValue);
        ...
        transactionHeading= new TransactionHeading();
        transactionHeading.heading = "Transaction Response";
        transactionHeading.transactionRowValueList = new ArrayList<>();
